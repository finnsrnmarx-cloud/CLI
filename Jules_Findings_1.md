...
* `184`: Stepping by 6 from byte 91 (the second DQT marker) yields a hex sum of `184`. Strikingly, 184 is the sum of the atomic numbers of the 6 elements explicitly king-pathed in the grid.
